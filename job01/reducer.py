...
with PdfPages(output_pdf_file) as pdf:
    for codcli, data in top_clients:
        ...
        colors = plt.cm.Paired(np.linspace(0, 1, len(sizes)))  # Palette de couleurs
        ...
        # Ajouter une annotation supplémentaire pour la fidélité
        plt.text(0, 1.2, 'Fidélité cumulée: {}'.format(data['fidelite']), horizontalalignment='center')
